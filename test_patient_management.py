...
class TestPaciente(unittest.TestCase):
    def test_patient_creation(self):
        ...
        self.assertEqual(paciente.name, "Juan Perez")
    ...
    def test_patient_to_dict_and_from_dict(self):
        ...
        self.assertEqual(paciente_dict["name"], "Maria Lopez")
...
class TestListaEnlazada(unittest.TestCase):
    def test_append_and_to_list(self):
        lista = ListaEnlazada()
        p1 = Paciente("111111111", "A", 20, "M")
        p2 = Paciente("222222222", "B", 30, "F")
        lista.append(p1)
        lista.append(p2)
    ...
    def test_search(self):
        lista = ListaEnlazada()
        p = Paciente("333333333", "Carlos", 40, "M")
        lista.append(p)
...
class TestCola(unittest.TestCase):
    def test_queue_operations(self):
        cola = Cola()
        p1 = Paciente("444444444", "A", 10, "M")
        p2 = Paciente("555555555", "B", 20, "F")
        cola.enqueue(p1)
        cola.enqueue(p2)
...
class TestGestorPacientes(unittest.TestCase):
    ...
    def test_add_and_get_patient(self):
        ...
        self.assertEqual(recuperado.name, "Test User")
    ...
    def test_duplicate_patient_id(self):
        ...
        gestor.patient_list = ListaEnlazada()
        # Añadimos un paciente
        paciente1 = gestor.add_patient("1234567890", "Paciente Uno", 30, "Masculino")
        self.assertIsNotNone(paciente1)
        # Intentamos añadir un paciente con la misma cédula
        paciente2 = gestor.add_patient("1234567890", "Paciente Dos", 40, "Femenino")
        self.assertIsNone(paciente2)
